<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
 <%@ page import="java.util.List, java.util.Arrays, com.harmtedyshop.dao.AdminDAO, java.sql.SQLException" %>
...
if (loggedInUser != null) {
    ...
    try {
        userRole = adminDAO.getRoleByUsername(loggedInUser);
    } catch (SQLException e) {
        e.printStackTrace(); // Handle the exception appropriately
    }
}

// List of valid roles for branch access
List<String> validRoles = Arrays.asList("mu_branch", "cbu_branch", "iringa_branch");

if (loggedInUser == null || userRole == null || !validRoles.contains(userRole)) {
...
<head>
    ...
    <title>Branch| BranchProducts</title>
        ...
        <div class="col-12 p-0 navbar_holder">
            <nav class="navbar navbar-expand-md">
                <div class="container-fluid whole_holder_navbar">
                    <a href="" class="tittle  d-none d-md-block">PRODUCTS</a>
                    ...
                    <div class="d-flex d-md-none order-lg-1 ms-auto" role="searh">
                        <a href="" class="locate_store tittle   d-block d-md-none">PRODUCTS</a>
                    </div>
