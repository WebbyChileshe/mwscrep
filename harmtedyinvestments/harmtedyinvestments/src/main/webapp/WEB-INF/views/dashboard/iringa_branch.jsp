...
if (loggedInUser == null || !"iringa_branch".equals(userRole)) {
...
<head>
<meta charset="UTF-8">
<title>Harmtedy Investments| IRINGA Branch</title>
...
<section class="cards_holder">
	...
	<div class="container-fluid content_holder">
		<h2 class="branch_name text-center mt-4">IRINGA BRANCH</h2>
