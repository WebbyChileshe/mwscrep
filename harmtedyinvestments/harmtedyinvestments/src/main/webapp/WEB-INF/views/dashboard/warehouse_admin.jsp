...
<head>
<meta charset="UTF-8">
<title>Harmtedy Investments| Admin</title>
...
<section class="cards_holder">
	<div class="container-fluid content_holder">
		...
		<h2 class="branch_name text-center mt-4">Lusaka Warehouse</h2>


		<div class="row mt-5 p-1">

			<div class="col-12 col-xl-3 col-md-4 col-sm-6 mb-4">
				<a href="${pageContext.request.contextPath}/managesales">
			...
			<div class="col-12 col-xl-3 col-md-4 col-sm-6 mb-4">
				<a href="${pageContext.request.contextPath}/warehouseproducts">
					<div class="card h-100 py-4">
						<div class="card-body">
							<i class="fas fa-warehouse"></i> 
							<span class="nav-link">WAREHOUSE
								PRODUCTS</span>
						</div>
					</div>
				</a>
			...
			<div class="col-12 col-xl-3 col-md-4 col-sm-6 mb-4">
				<a href="${pageContext.request.contextPath}/adminprofile">
					<div class="card h-100 py-4">
						<div class="card-body">
							<i class="fas fa-user-cog"></i> <span class="nav-link">ADMIN
								PROFILE</span>
						</div>
					</div>
				</a>
			...
			<div class="col-12 col-xl-3 col-md-4 col-sm-6 mb-4">
				<a href="${pageContext.request.contextPath}/managebranchstaffs">
					<div class="card h-100 py-4">
						<div class="card-body">
							<i class="fas fa-users"></i> <span class="nav-link">MANAGE
								STAFF</span>
						</div>
					</div>
				</a>
			...
			<div class="col-12 col-xl-3 col-md-4 col-sm-6 mb-4">
				<a href="${pageContext.request.contextPath}/manageloans">

					<div class="card h-100 py-4">
						<div class="card-body">
							<i class="fas fa-hand-holding-usd"></i> <span class="nav-link">LOANS</span>
						</div>
					</div>
				</a>
			</div>
			...
			<div class="col-12 col-xl-3 col-md-4 col-sm-6 mb-4">
				<a href="${pageContext.request.contextPath}/managepayments">

					<div class="card h-100 py-4">
						<div class="card-body">
							<i class="fas fa-credit-card"></i> <span class="nav-link">PAYMENTS</span>
						</div>
					</div>
				</a>
			</div>
			...
			<div class="col-12 col-xl-3 col-md-4 col-sm-6 mb-4">
				<a href="${pageContext.request.contextPath}/managebranches">
					<div class="card h-100 py-4">
						<div class="card-body">
							<i class="fas fa-users"></i> <span class="nav-link">MANAGE
								STAFF</span>
