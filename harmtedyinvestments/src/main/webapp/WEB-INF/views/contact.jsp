...
<head>
<meta charset="UTF-8">
<title>Harmtedy Investments| Contact</title>
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/shopfiles/shopcss/contact.css">
...
<body>
	...
	<section class="contact_us contact" id="contact">

		<p class="text-center">Feel free to send us a message about our
			products.</p>
		...
		<div class="contact_wrapper">
			<div class="number">
				<div>
					...
					<p class="value">Lusaka Iringa Mall Shop No.20</p>
				</div>
				...
				<div>
					...
					<p class="value">+260 975 3471 76</p>
				</div>
				...
				<div>
					...
					<p class="value">harmtedy@gmail.com</p>
				</div>
			...
			<div class="messages">
				<form id="contact-form" onsubmit="return validateForm()">
					<input type="text" id="user_name" name="name" class="name"
						placeholder="Your Name" required> <input type="email"
						id="user_email" name="email" class="email"
						placeholder="Your Email" required>
					<textarea style="resize: none;" id="message" name="message"
						class="message" cols="30" rows="10"
						placeholder="Your Message to  Harmtedy" required></textarea>
			...
			<div class="google_map ">
				<iframe
					src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3859.472302898429!2d28.27835396012696!3d-15.42409730563446!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1940f35cbce919c1%3A0x257570e25f16a7bc!2sIringa%20Shopping%20mall!5e0!3m2!1sen!2szm!4v1724017848052!5m2!1sen!2szm"
