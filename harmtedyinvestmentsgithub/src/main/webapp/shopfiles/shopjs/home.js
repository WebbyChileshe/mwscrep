document.addEventListener("DOMContentLoaded", function() {
	...
	const contextPath = '/harmtedyinvestments';

	const backgrounds = [
		`${contextPath}/shopfiles/welcome-images/laptophomeimage1.jpg`,
		`${contextPath}/shopfiles/welcome-images/airpodsimage.jpg`,
		`${contextPath}/shopfiles/welcome-images/homeimage2.jpg`,
	];
